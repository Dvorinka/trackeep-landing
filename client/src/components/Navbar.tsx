/*
 * Trackeep Navbar
 * Design: Minimal top nav with logo left, links center, CTA right
 * Style: Glassmorphism backdrop-blur, transparent background that gains opacity on scroll
 * Color: White text on dark, blue accent for CTA
 */
        ...
        <div className="flex items-center justify-between h-16 lg:h-18">
          ...
          <div className="hidden lg:flex items-center gap-3">
            <a
              ...
              className="group inline-flex items-center gap-2 px-3 py-1.5 text-sm font-medium rounded-lg border border-white/10 bg-white/[0.05] text-white/70 hover:text-white hover:border-white/20 hover:bg-white/[0.1] transition-all duration-200"
            >
